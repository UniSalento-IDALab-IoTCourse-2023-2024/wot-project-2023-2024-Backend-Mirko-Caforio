package it.unisalento.iotproject.machineservice.business.exchanger;

import com.fasterxml.jackson.databind.ObjectMapper;
import it.unisalento.iotproject.machineservice.business.publisher.MosquittoPublisher;
import it.unisalento.iotproject.machineservice.dto.AuthRequestDTO;
...
public class MosquittoExchanger {
    ...
    public void handleAuthResponse(Message<?> message) throws Exception {
        LOGGER.info("SONO DENTRO HANDLE AUTH RESPONSE");
